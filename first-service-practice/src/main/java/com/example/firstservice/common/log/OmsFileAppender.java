//package com.example.firstservice.common.log;
//
...
//	private String scheduledFilename = StringUtils.EMPTY;
...
//		setServer_num(appenderInfo.get("server_num").toString());
...
//					}*/
//
//					scheduledFilename = path + prefix + "." + server_num + sDateFormat.format(rolling.getCurrentCheck(now)) + suffix;
//
...
//			}
//		}
//		if("".equals(event.getMessage().getFormat())) {
//			return;
//		}
//
...
//			dailyFolder(now);
//
//			/*if ( server_num == null ||  server_num.equals(""))
//				return;*/
//
//			// 현재 파일명 찾기
//			String nextFilename = path + prefix + "." + server_num + sDateFormat.format(rolling.getCurrentCheck(now)) + suffix;
//			// 기존 파일과 같으면 리턴
...
//                                                                                         @PluginAttribute("datePattern")String datePattern, @PluginAttribute("folderPattern")String folderPattern, @PluginAttribute("server_num")String server_num) {
//
//
...
//		appenderInfo.put("server_num", server_num);
//
